...
{
msg_info "=======> JUMPSERVER installation details  <======="
msg_info "Default Accounts details:"
msg_info "USER       -  PASSWORD       -  ACCESS"
msg_info "admin       -  ChangeMe      -  admin account,"
echo ""
msg_info "You can access to your jumpserver from this links:"
msg_info "http://$IPADRESS or http://$HOST" 
echo ""
msg_info "<==========================================>"
echo ""
}
